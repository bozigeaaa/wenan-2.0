...
完整稿必须读取 `.agents/skills/references/expression-craft.md`，逐项检查理解、朗读、重复表达和语气，并核对问句、新闻信息与动作结尾。项目口语标准优先于下方上游对填充词、正式词、短句和结尾的通用处理；可以删除刻意添加的口语词，保留有功能的衔接和已授权的互动结尾。自然且没有刻意标记词的表达可通过，具体标准以该共享规则为准。
